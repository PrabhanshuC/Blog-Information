...
const Account_Management_Page = () =>
{
    ...
    return (
        <Container maxWidth="md">
            <Paper elevation={3} sx={{ p: { xs: 2, md: 4 }, mt: 2, minHeight: '600px' }}>
                ...
                <Box component="form" onSubmit={handle_profile_update} sx={{ mb: 5 }}>
                    ...
                    <Button
                        ...
                        variant="contained"
                        size="large"
                        disabled={updating_profile ? true : false}
                ...
                <Box>
                    ...
                    <Button
                        ...
                        disabled={deleting_account ? true : false}
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={handle_delete_account_request} color="error" autoFocus disabled={deleting_account ? true : false}>
