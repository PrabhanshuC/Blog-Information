...
import TitleIcon from '@mui/icons-material/Title'; // For Heading 1
import LooksTwoIcon from '@mui/icons-material/LooksTwo'; // For Heading 2
import Looks3Icon from '@mui/icons-material/Looks3'; // For Heading 3
import RemoveIcon from '@mui/icons-material/Remove'; // For Horizontal Rule
...
export const Edit_Article = () =>
{
    ...
    const [view_mode, set_view_mode] = useState('write'); // 'write' or 'preview'

    const content_ref = useRef(null); // Ref to access the TextField DOM element

    // Helper function to insert/wrap markdown syntax
