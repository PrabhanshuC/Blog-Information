...
export const Account_Settings = () =>
{
    ...
    useEffect(() => {
        const fetch_user_data = async () => {
            if (user && token) {
                ...
                try {
                    // Fetch full user profile to pre-fill form
    ...
    if (loading_profile) return <Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}><CircularProgress /></Box>;
        ...
        <Paper elevation={3} sx={{ p: { xs: 2, md: 4 }, mt: 2, minHeight: '600px' }}>
            ...
            <Box component="form" onSubmit={handle_profile_update} sx={{ mb: 5 }}>
                ...
                <TextField
                    fullWidth
                    label="Username"
                    value={user?.username || ''} // Username is read-only
